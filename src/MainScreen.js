...
function MainScreen({ todos, remove, edit }) {
  return (
    <div className="bg-black flex flex-col items-center gap-3 min-h-screen ">
      ...
      <Link
        className=" flex justify-center items-center text-white text-xl border-2 border-solid bg-indigo-500 border-indigo-500 rounded-lg px-10 text-center font-semibold"
        to="./form"
      >
